...
class GaitAnalyzer:
    ...
    def calculate_parameters(self):
        ...
        summary = {
            ...
            'walking speed (m/s)': round(walking_speed, 2),
            'avg Left step length (cm)': round(metrics_df[metrics_df['Side']=='Left']['Value (cm)'].mean(), 2),
            'avg Right step length (cm)': round(metrics_df[metrics_df['Side']=='Right']['Value (cm)'].mean(), 2)
        }
