...
class GaitAnalyzer:
    def __init__(self, csv_path, fps, height_axis="y", up_direction=-1, start_frame=None, end_frame=None):
        ...
        # --- NEW: Crop the dataframe based on frame_idx ---
...
def main():
    ...
    START_FRAME = 40   # Set to None if you want to start from the beginning
    END_FRAME = 220     # Set to None if you want to process until the end
    # -------------------------------------
