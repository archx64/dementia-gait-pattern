...
def copy_selected_frames(source_dir, dest_dir, start_frame, fps=25, middle_offset=12):
    ...
    while current_base <= max_frame:
        ...
        # 2. Grab the "Middle Frame" (+12 frames away)
...
def main():
    copy_selected_frames(source_dir=SOURCE_DIRECTORY, dest_dir=DESTINATION_DIRECTORY, start_frame=STARTING_FRAME, fps=200, middle_offset=100)
